...
def args_parser():
    ...
    parser.add_argument('--dataset', type=str,
                        default='fundus', help='dataset name')
    ...
    parser.add_argument('--non_iid_prob_class', type=float,
                        default=0, help='parameter for non-iid')
    parser.add_argument('--alpha_dirichlet', type=float,
                        default=3.0, help='parameter for non-iid')
    parser.add_argument('--local_ep', type=int, default=3, help='local epoch')
    parser.add_argument('--rounds', type=int, default=60, help='rounds')
    ...
    parser.add_argument('--end', type=int, default=50, help='ramp up end')
    ...
    parser.add_argument('--noise_client_ratio', type=float, default=0.8, help="noise client ratio")
